...
export default function Document() {
  ...
  const handleTextAlign = (e) => {
    ...
    document.documentElement.style.setProperty("--doc-align", e.target.value);
  };
  ...
  return (
    <>
      <Piano
        ...
        stopNote={() => {}}
        activeNotes={
          songPlaying && noteIndex < songPlaying.notes.length
            ? [MidiNumbers.fromNote(songPlaying.notes[noteIndex])]
            : []
        }
      />
      <div>
